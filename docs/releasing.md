...
LocalAI Kit publishes seven packages as one coordinated release, all sharing
...
4. [`local_ai_sherpa`](https://pub.dev/packages/local_ai_sherpa)
5. [`local_ai_kit`](https://pub.dev/packages/local_ai_kit)
6. [`local_ai_genkit`](https://pub.dev/packages/local_ai_genkit)
7. [`bedge_ai`](https://pub.dev/packages/bedge_ai)

Current release: **0.0.2** (`bedge_ai` is the renamed `local_ai_kit_all`,
...
Until this is done for all seven packages, releases must be published
...
in all seven package pubspec/changelog files (and any internal
